...
ZH_CN_TRANSLATIONS: dict[str, str] = {
    ...
    "Detect automatically on startup": "启动时自动检测",
    "Turn this off to leave detection paused at the next startup; you can still start it manually.": "关闭后，下次启动时检测将保持暂停；仍可手动开始检测。",
    "Detect now": "立即检测",
    "Cancel detection": "取消检测",
    "Detection scheduled": "检测已计划",
    "Hardware detection will start shortly.": "硬件检测即将开始。",
    "You can select a source now or skip this startup check.": "现在可以选择源文件，或跳过本次启动检测。",
    "Starting soon": "即将开始",
    "Skip startup detection": "跳过启动检测",
    "Detection paused": "检测已暂停",
    "Hardware detection is paused. Select a source or choose Detect now.": "硬件检测已暂停。可以先选择源文件，或点击“立即检测”。",
    "Detection is required before compression can start.": "开始压制前必须完成检测。",
    "Not started": "尚未开始",
    "Detecting…": "正在检测…",
    "Estimating remaining time…": "正在估算剩余时间…",
    "Cancelling hardware detection…": "正在取消硬件检测…",
    "Stopping the active encoder test and preserving previous results…": "正在停止当前编码器测试并保留之前的结果…",
    "Startup hardware detection was skipped.": "已跳过启动硬件检测。",
    "{current}/{total} · {elapsed:.1f}s elapsed · estimating…": "{current}/{total} · 已用 {elapsed:.1f} 秒 · 正在估算…",
    "{current}/{total} · {elapsed:.1f}s elapsed · about {remaining:.1f}s remaining": "{current}/{total} · 已用 {elapsed:.1f} 秒 · 约剩余 {remaining:.1f} 秒",
    "{current}/{total} · {elapsed:.1f}s elapsed": "{current}/{total} · 已用 {elapsed:.1f} 秒",
    "Step {current} of {total}: {status}\nYou can select a source while detection continues, or cancel this check.": "第 {current}/{total} 步：{status}\n检测期间仍可选择源文件，也可以取消本次检测。",
    "Previous results retained": "已保留上次检测结果",
    "Cancelled after {seconds:.1f}s": "已在 {seconds:.1f} 秒后取消",
    "Detection cancelled": "检测已取消",
    "No results were applied. Choose Detect now when you are ready.": "未应用任何检测结果。准备好后请选择“立即检测”。",
    "Hardware detection cancelled.": "硬件检测已取消。",
    "Hardware detection cancelled: {message}": "硬件检测已取消：{message}",
    "Waiting for the active hardware test to stop…": "正在等待当前硬件测试停止…",
    ...
    "Scanning CPU, GPU, and NPU devices…": "正在扫描 CPU、GPU 和 NPU 设备…",
    "Reading the FFmpeg encoder list…": "正在读取 FFmpeg 编码器列表…",
    "Preparing encoder validation…": "正在准备编码器验证…",
    "Testing {encoder}: {depth}-bit {mode}": "正在测试 {encoder}：{depth}-bit {mode}",
    "Skipping {encoder}: unavailable on this system": "跳过 {encoder}：当前系统不可用",
    "Finished testing {encoder}": "已完成 {encoder} 测试",
    "Reading the FFmpeg version…": "正在读取 FFmpeg 版本…",
    "Hardware detection completed.": "硬件检测已完成。",
